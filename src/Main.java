...
switch(op){
case "1": hotel.criarReservaComoAdmin();
break;
case "2": hotel.verTodasReservas();
break;
case "3": hotel.editarReservaAdmin();
break;
case "4": hotel.excluirReservaAdmin();
break;
case "5": hotel.verPorNumeroDeQuarto();
break;
case "6": hotel.verPorDia();
break;
...
switch (op) {
case "1": hotel.criarReservaComoCliente(cliente);
break;
case "2": hotel.verReservasDoCliente(cliente);
break;
case "3": System.out.println("Sessão terminada \n");
break;
default: System.out.println("Opção inválida \n");
}
if (op.equals("3"))
